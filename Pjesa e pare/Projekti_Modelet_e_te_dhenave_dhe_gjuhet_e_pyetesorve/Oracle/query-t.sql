...
/***** Query : Listoni tï¿½ gjitha stacionet meteorologjike qï¿½ nï¿½ datï¿½n 12 dhjetor 2019 dhe orï¿½n 02:00 PM nuk kanï¿½ pasur reshje bore *****/
...
/***** QUERY : Listoni tï¿½ gjitha vendet qï¿½ janï¿½ tï¿½ rrezikuara nga ndotja e ajrit dhe ndotï¿½sit pï¿½rkatï¿½s*****/
SELECT C.Vendi,
              N.Ndotesi
FROM Cilesia_Ajrit C, TABLE (C.Ndotja) N
